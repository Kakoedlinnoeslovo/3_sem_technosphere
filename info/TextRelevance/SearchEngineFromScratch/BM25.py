...
class BM25:
    ...
    def _get_bigram_tf(self, term1, term2, positions1, positions2, title, title_weight):
        ...
        for i, pos1 in enumerate(positions1):
            ...
            temp_tf_right_order = len(temp_array[temp_array == 1]) * 1
            temp_tf_wrong_order = len(temp_array[temp_array == - 1]) * 0.5

            temp_tf_right_order_next = len(temp_array[temp_array == 2]) * 0.5
            temp_tf_wrong_order_next = len(temp_array[temp_array == -2]) * 0.5
